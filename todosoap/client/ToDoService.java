 ...
 * 
 */
@WebServiceClient(name = "ToDoService", targetNamespace = "http://todo/", wsdlLocation = "http://localhost:8080/todo2/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ToDoSERVICE_QNAME = new QName("http://todo/", "ToDoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/todo2/?wsdl");
    ...
    public ToDo getToDoPort() {
        return super.getPort(new QName("http://todo/", "ToDoPort"), ToDo.class);
    }
    ...
    public ToDo getToDoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://todo/", "ToDoPort"), ToDo.class, features);
    }
